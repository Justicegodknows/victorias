    ...
    <div className="flex flex-1 flex-col">
      ...
      <nav className="sticky top-0 w-full z-50 glass-nav shadow-[0px_20px_40px_rgba(26,27,34,0.06)]">
        <div className="flex justify-between items-center px-8 h-20 w-full max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-12">
            <span className="text-2xl font-black tracking-tighter text-emerald-900 dark:text-emerald-50 font-[family-name:var(--font-geist-sans)]">
              Victoria&apos;s
            </span>
            <div className="hidden md:flex gap-8 items-center">
              <Link href="/" className="font-[family-name:var(--font-geist-sans)] font-semibold tracking-tight text-emerald-700 dark:text-emerald-400 border-b-2 border-emerald-700 dark:border-emerald-400 pb-1">
                Discover
              </Link>
              <Link href="/tenant/browse" className="font-[family-name:var(--font-geist-sans)] font-semibold tracking-tight text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 transition-colors">
                Listings
              </Link>
              <Link href="/tenant" className="font-[family-name:var(--font-geist-sans)] font-semibold tracking-tight text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 transition-colors">
                Concierge
              </Link>
              <Link href="/tenant/saved" className="font-[family-name:var(--font-geist-sans)] font-semibold tracking-tight text-zinc-500 dark:text-zinc-400 hover:text-emerald-600 transition-colors">
                Saved
              </Link>
            </div>
          </div>
      ...
      <section className="hero-gradient pt-24 pb-32 px-8 overflow-hidden">
        <div className="max-w-screen-xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h1 className="font-[family-name:var(--font-manrope)] text-6xl md:text-7xl font-extrabold tracking-tight text-[#1a1b22] dark:text-zinc-50 mb-8 leading-[1.1]">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="rounded-2xl shadow-2xl relative z-10 w-full aspect-square bg-gradient-to-br from-emerald-100 to-emerald-50 dark:from-zinc-800 dark:to-zinc-900 flex items-center justify-center">
      ...
      <section className="py-24 px-8 bg-[#fbf8ff] dark:bg-zinc-950">
        <div className="max-w-screen-xl mx-auto">
          <div className="mb-16">
            <span className="font-[family-name:var(--font-geist-mono)] text-[#006b2c] dark:text-emerald-400 uppercase tracking-[0.3em] font-bold text-sm">
              Capabilities
            </span>
            <h2 className="font-[family-name:var(--font-manrope)] text-4xl font-bold mt-4 dark:text-zinc-50">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => (
              <div key={feature.title} className="bg-[#f4f2fd] dark:bg-zinc-900 p-8 rounded-2xl hover:bg-[#e3e1ec] dark:hover:bg-zinc-800 transition-colors group">
                ...
                <h3 className="font-[family-name:var(--font-manrope)] text-xl font-bold mb-3 dark:text-zinc-50">
                  {feature.title}
                </h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {cities.map((city) => (
              <div key={city.name} className={`relative group cursor-pointer overflow-hidden rounded-2xl shadow-xl ${city.offset ? "md:translate-y-12" : ""}`}>
                <div className="w-full aspect-[3/4] bg-gradient-to-br from-emerald-700 to-emerald-900 group-hover:scale-110 transition-transform duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-transparent to-transparent opacity-80" />
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="text-white font-[family-name:var(--font-manrope)] text-3xl font-bold mb-2">{city.name}</h3>
                  <div className="flex flex-wrap gap-2">
                    {city.neighborhoods.map((n) => (
                      <span key={n} className="text-zinc-300 text-xs font-[family-name:var(--font-geist-mono)] bg-white/10 backdrop-blur-md px-3 py-1 rounded-full">
                        {n}
                      </span>
                    ))}
                  </div>
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="bg-[#1a1b22] dark:bg-zinc-800 rounded-[2.5rem] p-12 md:p-20 relative overflow-hidden">
            <div className="relative z-10 max-w-2xl">
              <h2 className="font-[family-name:var(--font-manrope)] text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Are you a landlord?
              </h2>
