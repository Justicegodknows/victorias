...
// In the JSX, update the error display:
{(error || callbackError) && (
...
{!otpSent && (
    ...
    <button
        type="button"
        className="flex items-center justify-center gap-3 py-3 rounded-xl bg-[#efe0d2] dark:bg-zinc-800 text-[#6a5e54] dark:text-zinc-400 font-medium hover:bg-[#e8e7f1] dark:hover:bg-zinc-700 transition-colors"
    >
        Facebook
    </button>
