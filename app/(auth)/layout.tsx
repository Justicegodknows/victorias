...
export default function AuthLayout({
    ...
    return (
        <div className="relative flex min-h-full flex-1 flex-col items-center justify-center bg-[#f5ebe2] dark:bg-zinc-950 px-4 py-8 md:py-12">
            {/* Background blurs */}
            <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] bg-[#7b5d43]/5 rounded-full blur-[120px]" />
                <div className="absolute bottom-[-10%] right-[-5%] w-[30%] h-[30%] bg-[#3b6842]/5 rounded-full blur-[100px]" />
            </div>

            {/* Brand */}
            <div className="text-center mb-12">
                <Link href="/" className="font-(family-name:--font-geist-sans) text-4xl font-black tracking-tighter text-[#7b5d43] dark:text-amber-400">
                    Victoria&apos;s
                </Link>
                <p className="text-[#6a5e54] dark:text-zinc-400 font-medium tracking-tight mt-2">
            ...
            <div className="fixed bottom-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-[#7b5d43]/20 to-transparent" />
        </div>
    );
}
