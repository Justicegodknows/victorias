...
export default async function TenantViewingsPage(): Promise<React.ReactElement> {
    ...
    const { data: requests } = await supabase
        ...
        .select("*, apartments(title, neighborhood, city, ppid)")
        ...
        <div className="max-w-3xl mx-auto">
            <div className="mb-8">
                ...
                <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                    Track the status of your apartment viewing requests.
                </p>
            </div>
            ...
            {rows.length === 0 ? (
                <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-12 text-center">
                    ...
                    <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                        Browse apartments and click &quot;Request Viewing&quot; to get started.
                    </p>
                </div>
            ) : (
                    ...
                    {rows.map((req) => (
                        ...
                        >
                            ...
                            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                                <div>
                                    <p className="text-xs font-mono uppercase tracking-[0.15em] text-zinc-400">Date</p>
                                ...
                                <div>
                                    <p className="text-xs font-mono uppercase tracking-[0.15em] text-zinc-400">Time</p>
                                    <p className="mt-0.5 text-zinc-700 dark:text-zinc-300">
                                        {TIME_LABELS[req.preferred_time] ?? req.preferred_time}
                                    </p>
                                </div>
                            </div>
                            ...
                            {req.message && (
                                <div className="mt-3">
                                    <p className="text-xs font-mono uppercase tracking-[0.15em] text-zinc-400">Your message</p>
