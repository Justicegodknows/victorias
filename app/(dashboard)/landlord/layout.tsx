                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-3 border-l border-zinc-200/50 pl-4 dark:border-zinc-700/50">
                            <div className="hidden text-right sm:block">
                                <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-400">Landlord</p>
            ...
            <main className="flex min-h-[calc(100vh-5rem)]">
                <aside className="sticky top-20 hidden h-[calc(100vh-5rem)] w-64 shrink-0 flex-col gap-2 bg-zinc-50 px-4 py-8 md:flex dark:bg-zinc-950">
                    <div className="mb-6 px-4">
                        <p className="mb-4 font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-400">Landlord Dashboard</p>
                        <div className="space-y-1">
                            ...
                            <Link href="/landlord/listings/new" className="flex items-center gap-3 rounded-lg px-4 py-2.5 text-zinc-500 transition-all hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-900">
                                <span>➕</span>
                            ...
                            {allowRoleSwitch && (
                                <Link href="/tenant" className="flex items-center gap-3 rounded-lg px-4 py-2.5 text-zinc-500 transition-all hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-900">
                                    <span>🔁</span>
                                    <span className="text-sm">Switch to Tenant</span>
                                </Link>
                            )}
                        </div>
                    </div>
            ...
            <nav className="fixed bottom-0 z-50 w-full rounded-t-3xl bg-zinc-50/80 backdrop-blur-xl shadow-[0px_-10px_30px_rgba(0,0,0,0.05)] md:hidden dark:bg-zinc-950/80">
                <div className="flex h-20 items-center justify-around px-6">
                    <Link href="/landlord" className="flex flex-col items-center justify-center px-4 py-1 text-zinc-400 dark:text-zinc-600">
                        <span>🏢</span>
                        <span className="mt-1 font-mono text-[10px] uppercase tracking-[0.2em]">Listings</span>
                    </Link>
                    <Link href="/landlord/inquiries" className="flex flex-col items-center justify-center px-4 py-1 text-zinc-400 dark:text-zinc-600">
                        <span>📩</span>
                        <span className="mt-1 font-mono text-[10px] uppercase tracking-[0.2em]">Inquiries</span>
                    </Link>
                    <Link href="/landlord/chat" className="flex flex-col items-center justify-center px-4 py-1 text-zinc-400 dark:text-zinc-600">
                        <span>💬</span>
                    ...
                    {allowRoleSwitch && (
                        <Link href="/tenant" className="flex flex-col items-center justify-center px-4 py-1 text-zinc-400 dark:text-zinc-600">
                            <span>🔁</span>
                            <span className="mt-1 font-mono text-[10px] uppercase tracking-[0.2em]">Tenant</span>
                        </Link>
                    )}
                </div>
            </nav>
