...
// meta-llama/Llama-3.1-8B-Instruct is free and ungated on the HF router.
// HF migrated from api-inference.huggingface.co/v1 → router.huggingface.co/v1 (Apr 2026).
